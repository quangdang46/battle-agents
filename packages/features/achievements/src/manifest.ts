 ...
 */
export const ACHIEVEMENTS_ACTION_IDS = [
  'achievements.catalogue',
  'achievements.list',
  'achievements.project',
] as const;

export type AchievementsActionId = (typeof ACHIEVEMENTS_ACTION_IDS)[number];
...
export type AchievementsActionTypes = {
  [K in AchievementsActionId]: { input: unknown; output: unknown };
};
